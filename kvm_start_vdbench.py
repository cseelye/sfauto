...
# This script will start vdbench on a list of VMs
...
vm_name = ""                    # The name of the VM to start vdbench
                                # --vm_name

vm_regex = ""                   # Regex to match to select VMs to start vdbench
                                # --vm_regex

vm_count = 0                    # The number of matching VMs to start vdbench
                                # --vm_count

vm_user = "root"                # The username for the VMs
                                # --vm_user

vm_pass = "solidfire"           # The password for the VMs
                                # --vm_pass
...
def main():
    ...
    parser.add_option("--vm_name", type="string", dest="vm_name", default=vm_name, help="the name of the single VM to start vdbench")
    parser.add_option("--vm_regex", type="string", dest="vm_regex", default=vm_regex, help="the regex to match names of VMs to start vdbench")
    parser.add_option("--vm_count", type="int", dest="vm_count", default=vm_count, help="the number of matching VMs to start vdbench (0 to use all)")
