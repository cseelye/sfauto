...
"""
This action will unplug all of the PBDs for the specified SR
...
When run as a script, the following options/env variables apply:
    ...
    --sr_name           The name of the SR to unplug - if there is no exact match the first SR name that contains this string will be used
"""
...
class XenUnplugSrAction(ActionBase):
    class Events:
        """
...
if __name__ == '__main__':
    ...
    parser.add_option("--sr_name", type="string", dest="sr_name", default=None, help="the name of the SR to unplug - if there is no exact match the first SR name that contains this string will be used")
