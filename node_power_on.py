...
from libsf.util import ValidateAndDefault, ItemList, IPv4AddressType, OptionalValueType, BoolType, StrType
...
def NodePowerOn(node_ips,
    ...
    for node_ip in node_ips:
        results.append(pool.Post(_IPMIThread, node_ip, node_ipmi[node_ip], ipmi_user, ipmi_pass, wait_for_up))
...
def _IPMIThread(node_ip, ipmi_ip, ipmi_user, ipmi_pass, wait_for_up):
    log = GetLogger()
