...
if __name__ == '__main__':
    ...
    parser.add_option("--ipmi_user", type="string", dest="ipmi_user", default=sfdefaults.ipmi_user, help="the SSH username for the nodes.  Only used if you do not have SSH keys set up")
    parser.add_option("--ipmi_pass", type="string", dest="ipmi_pass", default=sfdefaults.ipmi_pass, help="the SSH password for the nodes.  Only used if you do not have SSH keys set up")
