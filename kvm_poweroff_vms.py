...
class KvmPoweroffVmsAction(ActionBase):
    ...
    def _VmThreadPowerOff(self, vmHost, hostUser, hostPass, connection, vm, results):
        #connect again
        ...
        if vm_names != None:
            ...
            for name in vm_names:
                ...
                if state == libvirt.VIR_DOMAIN_SHUTOFF:
                    ...
                    th = multiprocessing.Process(target=self._VmThreadPowerOff, args=(vmhost, host_user, host_pass, connection, vm.name(), results))
                    th.daemon = True
