...
def ClientThread(client_ip, client_user, client_pass, account_name, svip, accounts_list, results, index):
...
def main():
    ...
    for client_ip in client_ips:
        ...
        th = multiprocessing.Process(target=ClientThread, args=(client_ip, client_user, client_pass, account_name, svip, accounts_list, results, thread_index))
        th.start()
