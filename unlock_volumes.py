...
def main():
    ...
    parser.add_option("--volume_name", type="string", dest="volume_name", default=volume_name, help="the volume to unlock")
    parser.add_option("--volume_id", type="int", dest="volume_id", default=volume_id, help="the volume to unlock")
    parser.add_option("--volume_prefix", type="string", dest="volume_prefix", default=volume_prefix, help="the prefix of volumes to unlock")
    parser.add_option("--volume_regex", type="string", dest="volume_regex", default=volume_regex, help="regex to search for volumes to unlock")
    parser.add_option("--volume_count", type="int", dest="volume_count", default=volume_count, help="the max number of volumes to unlock")
